        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <nav class="mt-1 text-sm text-muted">
                    ...
                    <span class="mx-1">/</span>
                    <span class="text-off-black font-medium">Create</span>
                </nav>
            </div>
        ...
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="bg-surface border border-oat rounded-card">
                <div class="px-6 py-5 border-b border-oat">
                    ...
                    <p class="mt-1 text-sm text-muted">Configure the subscription plan settings and limits.</p>
                </div>

                <form action="{{ route('admin.subscription-plans.store') }}" method="POST" class="px-6 py-6 space-y-6">
                    @csrf
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="number"
                                       ...
                                       value="{{ old('budget_usd_per_cycle') }}"
                                       required
                                       min="0"
                                       step="0.01"
                                       placeholder="0.00"
                    ...
                    <div>
                        ...
                        <textarea name="description"
                                  ...
                                  class="w-full rounded-btn border-oat focus:border-fin-orange focus:ring-fin-orange text-sm">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
